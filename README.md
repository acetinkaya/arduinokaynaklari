...
## Arduino ders çalışmaları ile ilgili kaynak kitapları, dokümanları ve eğitim materyallerini içeren bir listedir. Açık kaynak ve akademik içeriklere odaklanılmıştır.
...
| Temel Elektronik | Arduino örnekleriyle temel elektronik ders kitabıdır. | 978-975-511-169-7 | Birsen Yayınevi | [ Link ](https://www.amazon.com.tr/Temel-Elektronik-M-Sait-T%C3%BCrk%C3%B6z/dp/9755111697) | 2. | 


---

1. S. Özkan & H. A. Özkan, Uygulamalarla Temel Elektronik, Nobel Akademik Yayıncılık, Ankara, 2021.
2. M. Sait Türköz, Temel Elektronik, Birsen Yayınevi, İstanbul, 2009.
...
📢 **Önemli Not:** Bu liste, Arduino temelli uygulama geliştirme alanında kaynak paylaşımı amacıyla hazırlanmıştır. Listelenen bağlantılar, okuyuculara kolaylık sağlamak için eklenmiş olup herhangi bir reklam, sponsorluk veya ticari yönlendirme amacı taşımamaktadır. 
